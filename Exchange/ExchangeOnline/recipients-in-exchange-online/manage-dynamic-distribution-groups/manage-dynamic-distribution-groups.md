...
> [!IMPORTANT]
> Dynamic distribution groups are not synced from Exchange Onlint to Azure Active Directory or your on-premises Active Directory.  Which means they cannot be used with features such as Azure Conditional Access Policies.
